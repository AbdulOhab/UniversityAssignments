      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-lg-6 p-l-0 title-margin-right">
            <h3 class="page-header">Insert Author Details</h3>
          </div>
          <!-- /# column -->
        </div>
        <div class="row">
            ...
            <div class="card">
              <div class="card-body">
                <div class="basic-elements">
                  <form role="form" action="add_author_c.php" method="post">
                    <div class="form-group">
                      <label>Author Name:</label>
                      <input class="form-control" type="text" placeholder="Name" name="author_name" />
                    </div>
                    <div class="form-group">
                          ...
                          <table class="table table-hover ">
                            ...
                            <tbody>
                                <tr>
                                    <?php
                                    $inc = 1;
                                    $result = $conn->query("SELECT * FROM authors_name ORDER BY id DESC");
