...
<body>
    ...
    <div action="add_author_name.php" class="add_author">
        <form method="post">
            <fieldset>
                Add Publisher Name: <br> <input type="text" name="publication_name" value=""> <br>
    ...
    if (isset($_POST['submit'])) {
        ...
        $Query = "INSERT INTO publication_List(publication_name,other) VALUES('$publication_name','$comment')";
