...
<body>
    ...
    <div action="add_author_name.php" class="add_author">
        <form method="post">
            <fieldset>
                Add Author Name: <br> <input type="text" name="author_name" value=""> <br>
    ...
    if (isset($_POST['submit'])) {
        ...
        $Query = "INSERT INTO authors_name(author_name,other) VALUES('$author_name','$comment')";
