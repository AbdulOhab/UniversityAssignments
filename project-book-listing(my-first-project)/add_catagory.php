      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-lg-6 p-l-0 title-margin-right">
            <h3 class="page-header">Insert Catagory Details</h3>
          </div>
          <!-- /# column -->
        </div>
        <div class="row">
            ...
            <div class="card">
              <div class="card-body">
                <div class="basic-elements">
                  <form role="form" action="add_catagory_c.php" method="post">
                    <div class="form-group">
                      <label>Catagory Name:</label>
                      <input class="form-control" type="text" placeholder="Use Only English Name" name="catagory_name" />
                    </div>
                    <div class="form-group">
                           ...
                           <table class="table table-hover ">
                            ...
                            <tbody>
                                <tr>
                                    <?php
                                    $inc = 1;
                                    $result = $conn->query("SELECT * FROM catagory_list ORDER BY id DESC");
